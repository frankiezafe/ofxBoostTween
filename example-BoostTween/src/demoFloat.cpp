...
void demoFloat::keyPressed( int key ) {
...
void demoFloat::keyReleased( int key ) {}

void demoFloat::addlog( string s ) {
...
void demoFloat::tweenEvent( tween::TweenEvent & evt ) {
