...
void demoChar::keyPressed( int key ) {
...
void demoChar::keyReleased( int key ) {}

void demoChar::addlog( string s ) {
...
void demoChar::tweenEvent( tween::TweenEvent & evt ) {
